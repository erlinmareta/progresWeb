    ...
    <div class="page-wrapper bg-dark p-t-100 p-b-50">
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                ...
                <div class="card-body">
                    <form method="get" action="{{ url('simpandata') }}">
                        {{ csrf_field() }}
                        <div class="form-row">
                            <div class="name" placeholder="Nama Lengkap">Nama Lengkap</div>
                            <div class="value">
                ...
                <div class="card-body">
                    <form method="POST">
                         <div class="form-row">
                           <div class="name">No Handpone</div>
                           <div class="value">
                                 <input class="input--style-6" type="text" name="hp" placeholder="08********">
                          </div>
                       </div>
                    ...
                    <form method="POST">
                        <div class="form-row">
                             <div class="name">Paket</div>
                              <div class="value">
                                  <input class="input--style-6" type="text" name="paket" placeholder="Paket">
                                      </div>
                                   </div>
